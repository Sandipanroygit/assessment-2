...
export function AdminQuestionsView({ embedded = false }: AdminQuestionsViewProps) {
  ...
  const rootClassName = embedded ? "space-y-6" : "section-padding space-y-6";
